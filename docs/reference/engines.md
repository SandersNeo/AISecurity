...
> Проверено: 18 января 2026

---

## 🔬 18 января 2026 — Обновление R&D

### CVE-2026-22812 (OpenCode RCE)

**Вектор атаки:** Неаутентифицированный локальный HTTP API в AI-ассистентах кодирования

| Инструмент | Порты | Статус |
|------------|-------|--------|
| OpenCode | 4096-4099 | Исправлено в v1.0.216 |
| Cursor | 3000-3001 | Проверить CORS |
| GitHub Copilot | 8080 | Неизвестно |
| Codeium | 3300 | Неизвестно |
| TabNine | 9000 | Неизвестно |
| Continue | 65432 | Неизвестно |

**STRIKE Payloads:** +24 (session hijack, file read, reverse shell)

### ETSI EN 304 223

Первый глобально применимый европейский стандарт кибербезопасности ИИ (15 янв 2026).

**13 принципов в 5 фазах:**
...
**Концепция:** Сервер авторизации семантически анализирует запросы и выдаёт токены с минимальными правами.

**Ключевые компоненты:**
- NLP модуль семантического сопоставления
- Динамическое выделение прав
- Датасет ASTRA для бенчмаркинга
