...
- [ ] Понять supervisor agent patterns
- [ ] Анализировать supervisor security
- [ ] Имплементировать secure delegation
...
**Supervisor Agent** — агент верхнего уровня, который координирует работу subordinate agents.
