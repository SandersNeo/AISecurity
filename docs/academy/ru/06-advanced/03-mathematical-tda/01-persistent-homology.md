...
- [ ] Понять основы persistent homology
- [ ] Применять TDA к embedding space анализу
- [ ] Детектировать anomalies через topological features
...
**Topology** изучает свойства пространства, инвариантные к непрерывным деформациям.
