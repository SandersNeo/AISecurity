...
> **Ваше путешествие в AI security начинается здесь**

---

## Что такое AI Security Academy?

AI Security Academy — это комплексная образовательная платформа, предназначенная для обучения специалистов по безопасности, разработчиков и исследователей тому, как защищать AI системы от новых угроз. Независимо от того, защищаете ли вы от prompt injection атак, обеспечиваете безопасность agentic AI workflows или внедряете системы детекции — эта академия предоставит вам необходимые знания и практические навыки.
...
|-----------|----------------|
| **Security Engineers** | AI-специфичные векторы атак, техники детекции, incident response |
...
### 🛡️ Модуль 05: Defense Strategies
...
```
Foundations → Attack Vectors → ����������� Topics → Labs (Red)
```
...
### Quick Start
1. Прочитайте руководство [Как использовать эту Академию](01-how-to-use.md)
...
## Что делает эту Академию особенной
