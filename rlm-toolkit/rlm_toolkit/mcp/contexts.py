...
class ContextManager:
    ...
    def __init__(self, storage_dir: Optional[str] = None):
        ...
        self.storage_dir = Path(storage_dir) if storage_dir else self._find_storage_dir()
    ...
    def _find_storage_dir(self) -> Path:
        ...
        cwd = Path.cwd()
        markers = ['.git', 'pyproject.toml', 'package.json', '.rlm']
    ...
    async def load(self, path: str, name: Optional[str] = None) -> Dict[str, Any]:
        ...
        logger.info(f"Loaded context '{name}': {file_count} files, {token_count} tokens")
