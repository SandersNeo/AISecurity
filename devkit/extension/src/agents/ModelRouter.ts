...
export class ModelRouter {
     ...
     */
    getModel(agentType: AgentType, taskComplexity?: TaskComplexity): ClaudeModel {
     ...
     */
    getModelId(model: ClaudeModel): string {
        const modelIds: Record<ClaudeModel, string> = {
     ...
     */
    requiresPremiumModel(agentType: AgentType): boolean {
